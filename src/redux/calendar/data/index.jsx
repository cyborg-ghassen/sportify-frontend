...
mock.onGet("/account/calendar/events").reply((config) => {
...
// Add new event
mock.onPost("/account/calendar/add-event").reply((config) => {
...
// Update Event
mock.onPost("/account/calendar/update-event").reply((config) => {
...
// Remove Event
mock.onDelete("/account/calendar/remove-event").reply((config) => {
  let { id } = config;
