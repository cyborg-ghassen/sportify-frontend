    ...
    <Row gutter={[32, 32]} className="hp-mb-32">
      ...
      <Col span={24}>
        ...
        <Row className="hp-bg-color-black-0 hp-bg-color-dark-100 hp-border-radius hp-pr-sm-16 hp-pr-32">
          ...
          >
            <Switch>
              <Route path="/sessions/profile/personel-information" exact>
                <InfoProfile />
              </Route>

              <Route path="/sessions/profile/notifications">
                <NotificationsProfile />
              </Route>

              <Route path="/sessions/profile/activity">
                <ActivityProfile />
              </Route>

              <Route path="/sessions/profile/security">
                <SecurityProfile />
              </Route>

              <Route path="/sessions/profile/password-change">
                <PasswordProfile />
              </Route>

              <Route path="/sessions/profile/connect-with-social">
                <SocialProfile />
              </Route>
            </Switch>
          </Col>
