    ...
    <Col flex="240px" className="hp-profile-menu hp-py-24">
      <div className="hp-w-100">
        ...
        >
          ...
          >
            <Link to="/sessions/profile/personel-information">
          ...
          <Menu.Item
            ...
            onClick={props.onCloseDrawer}
          >
            <Link to="/sessions/profile/notifications">Notifications</Link>
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={props.onCloseDrawer}
          >
            <Link to="/sessions/profile/activity">Activity Monitor</Link>
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={props.onCloseDrawer}
          >
            <Link to="/sessions/profile/security">Security Settings</Link>
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={props.onCloseDrawer}
          >
            <Link to="/sessions/profile/password-change">Password Change</Link>
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={props.onCloseDrawer}
          >
            <Link to="/sessions/profile/connect-with-social">
              Connect with Social
            </Link>
          </Menu.Item>
        </Menu>
