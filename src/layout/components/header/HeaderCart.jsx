                      ...
                      <Col flex="1 0 0" className="hp-basket-dropdown-list-item-title">
                        <Row wrap={false}>
                          <Col flex="0 0 32px" className="hp-mt-4">
                            <Link
                              to={`/account/ecommerce/product-detail/${value.id}`} onClick={() => dispatch(loadCurrentItem(value))}
                            >
                              <Avatar
                                size={35}
        ...
        <Row gutter={[12]}>
          {
            cart.length !== 0 ? (
              <>
                <Col span={12}>
                  <Link to="/account/ecommerce/checkout" onClick={handleClick}>
                ...
                <Col span={12}>
                  <Link to="/account/ecommerce/address-information" onClick={handleClick}>
              ...
              <Col span={24}>
                <Link to="/account/ecommerce/shop" onClick={handleClick}>
